...
(function($) {
    ...
    // Function to get the date of the first Saturday of May 2024
    function getFirstSaturdayDate() {
        const targetDate = new Date(2024, 4, 1); // May is month 4 (0-based index)
    ...
    var countdown_date = getFirstSaturdayDate();
